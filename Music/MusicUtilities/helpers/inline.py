...
def play_markup(videoid, user_id):
    buttons = [
        [
            InlineKeyboardButton(text="الدعم╎🧤", url=f"https://t.me/{music_k2aba}"),
...
start_keyboard = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton(
                "الاوامـــر مـن هـنـا : 📚", url="https://t.me/Devk2aba/21"
            )
        ],
...
def start_pannel():
    ...
    if not CHANNEL and GROUP:
        buttons = [
            ...
            [
                InlineKeyboardButton(
                    text="الدعم╎🧤 ", url=f"https://t.me/{music_k2aba}"
                ),
            ],
        ]
    ...
    if CHANNEL and GROUP:
        buttons = [
            ...
            [
                InlineKeyboardButton(
                    text="✨ ᴄʜᴀɴɴᴇʟ", url=f"https://t.me/{k_2_a_b_a}"
                ),
                InlineKeyboardButton(
                    text="✨ sᴜᴘᴘᴏʀᴛ", url=f"https://t.me/{music_k2aba}"
                ),
            ],
        ]
        return f"🎛  **This is {BOT_NAME}**", buttons
...
def private_panel():
    ...
    :
        buttons = [
            ...
            [
                InlineKeyboardButton(
                    text="✨ ᴄʜᴀɴɴᴇʟ", url=f"https://t.me/{music_k2aba}"
                ),
            ],
        ]
        return f"🎛  **This is {BOT_NAME}**", buttons
