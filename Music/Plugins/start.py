...
def start_pannel():
    buttons = [
        [
            InlineKeyboardButton(text="جـروب الـدعـم╎🧤​", url=f"https://t.me/{music_k2aba}"),
            InlineKeyboardButton(text="قـنـاة السورس╎💡", url=f"https://t.me/{k_2_a_b_a}"),
        ],
        [
            InlineKeyboardButton("🚨╎الاوامـــر╎💁‍♂️", url="https://t.me/Devk2aba/21"),
        ],
        [
            InlineKeyboardButton("⁨⌯ ٰ𝘿ٌِ𝙀ٓ𝙑 ٰ𝐊2𝐀𝐁𝐀 ˹❤️‍🔥🍃˼⁩", url="https://t.me/k2_aba_0"),
        ],
    ]
    return (
