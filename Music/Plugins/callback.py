...
""",
        ...
        [
            InlineKeyboardButton("🔭╎support group", url=f"https://t.me/Music_k2aba}"),
            InlineKeyboardButton("📡╎Source channel", url=f"https://t.me/k_2_a_b_a}"),
        ],
        [
...
""",
        ...
        [
            InlineKeyboardButton("🔭╎جروب الدعم", url=f"https://t.me/music_k2aba"),
            InlineKeyboardButton("📡╎قناه السورس", url=f"https://t.me/k_2_a_b_a"),
        ],
        [
            InlineKeyboardButton("🎟╎الاوامر", url="https://t.me/Devk2aba/21"),
        ],
        [
    ...
    await query.edit_message_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [        
                    InlineKeyboardButton(
                        "⁨⁨⌯ ٰ𝘿ٌِ𝙀ٓ𝙑 ٰ𝐊2𝐀𝐁𝐀 ˹❤️‍🔥🍃˼⁩⁩", url=f"https://t.me/k2_aba_0"
                    ),
                ],
                [                  
                    InlineKeyboardButton(
    ...
    await query.edit_message_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [        
                    InlineKeyboardButton(
                        "⁨⌯ ٰ𝘿ٌِ𝙀ٓ𝙑 ٰ𝐊2𝐀𝐁𝐀 ˹✈🔥˼⁩", url=f"https://t.me/k2_aba_0"
                    ),
                ],
                [                  
                    InlineKeyboardButton(
